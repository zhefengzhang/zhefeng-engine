...
module.exports = link(mixin({
    ...
    scrollview: {
        ...
        virtual_list: '是否开启虚拟列表',
        item_template: '虚拟列表条目模板',
        padding_top: '容器内上边距，当开启垂直滚动时生效',
        padding_bottom: '容器内下边距，当开启垂直滚动时生效',
        padding_left: '容器内左边距，当开启水平滚动时生效',
        padding_right: '容器内右边距，当开启水平滚动时生效',
        spacing_x: '列表条目的节点水平间距，当开启水平滚动时生效',
        spacing_y: '列表条目的节点垂直间距，当开启垂直滚动时生效',
        horizontal: '是否开启水平滚动',
        vertical: '是否开启垂直滚动',
        inertia: '是否开启滚动惯性',
