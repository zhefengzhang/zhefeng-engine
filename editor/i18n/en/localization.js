...
module.exports = link(mixin({
    ...
    scrollview: {
        ...
        virtual_list: 'Enable virtual list',
        item_template: 'Virtual list item template',
        padding_top: 'Top margin inside the container, which takes effect when vertical scrolling is enabled',
        padding_bottom: 'Bottom margin inside the container, which takes effect when vertical scrolling is enabled',
        padding_left: 'Left margin inside the container, which takes effect when horizontal scrolling is enabled',
        padding_right: 'Right margin inside the container, which takes effect when horizontal scrolling is enabled',
        spacing_x: 'Horizontal spacing between nodes of list items, which takes effect when horizontal scrolling is enabled',
        spacing_y: 'Vertical spacing between nodes of list items, which takes effect when vertical scrolling is enabled',
