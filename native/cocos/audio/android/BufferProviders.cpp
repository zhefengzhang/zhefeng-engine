...
#include "audio/common/sonic/sonic.h"
...
//     size_t count = ccstd::min(mLocalBufferFrameCount, mBuffer.frameCount - mConsumed);
//     count = ccstd::min(count, pBuffer->frameCount);
...
//                 audio_bytes_per_frame(ccstd::max(inChannelCount, outChannelCount), format),
//                 frameCount),
//         mFormat(format),
